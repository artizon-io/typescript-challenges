...
let a : List.ZipObj<typeof tuple, typeof tuple>
...
type cases = [
  ...
  Expect<Equal<List.ZipObj<typeof tuple, typeof tuple>, { tesla: 'tesla'; 'model 3': 'model 3'; 'model X': 'model X'; 'model Y': 'model Y' }>>,
