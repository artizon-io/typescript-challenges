...
// nice try but cannot use infer without extends
// type Last<T extends [...args : any[], infer U]> = U
...
type cases = [
  ...
  Expect<Equal<List.Last<[3, 2, 1]>, 1>>,
  Expect<Equal<Last<[() => 123, { a: string }]>, { a: string }>>,
  Expect<Equal<List.Last<[() => 123, { a: string }]>, { a: string }>>,
]
